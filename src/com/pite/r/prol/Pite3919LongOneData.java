 ...
 */
@StructClass
public class Pite3919LongOneData extends APiteData {
	@StructField(order = 0)
	...
	public String toString() {
		return "Pite3919LongOneData [Voltage=" + Voltage + ", OhmR=" + OhmR + ", LinkRes=" + LinkRes + ", standRes="
				+ standRes + ", ExternalCurrent=" + ExternalCurrent + ", R2=" + R2 + ", C2=" + C2 + ", standVolt="
				+ standVolt + ", BattNo=" + BattNo + ", Status=" + Status + ", Cap=" + Cap + ", bak="
				+ Arrays.toString(bak) + "]";
	}
