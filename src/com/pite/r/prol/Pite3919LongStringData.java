 ...
 */
@StructClass
public class Pite3919LongStringData extends APiteData {
	@StructField(order = 0)
	...
	public String toString() {
		return "Pite3919LongStringData [Voltage=" + Voltage + ", OhmR=" + OhmR + ", LinkRes=" + LinkRes + ", standRes="
				+ standRes + ", ExternalCurrent=" + ExternalCurrent + ", R2=" + R2 + ", C2=" + C2 + ", standVolt="
				+ standVolt + ", BatteryNum=" + BatteryNum + ", BattNo=" + BattNo + ", Status=" + Status + ", Cap="
				+ Cap + ", LocationNo=" + Arrays.toString(LocationNo) + ", StringNo=" + Arrays.toString(StringNo) + "]";
	}
